<?php
/* Smarty version 3.1.29, created on 2018-07-16 15:34:00
  from "F:\home\class\day17\code\blog31\app\home\view\blogShowList.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5b4c4a689f6c89_90402768',
  'file_dependency' => 
  array (
    '07f3e86acbf7631988552bdd91c5385a130892ed' => 
    array (
      0 => 'F:\\home\\class\\day17\\code\\blog31\\app\\home\\view\\blogShowList.html',
      1 => 1531726413,
      2 => 'file',
    ),
  ),
...
function content_5b4c4a689f6c89_90402768 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
...
/index.php?p=home&m=index&a=login">
            <input type="username" name="acc" class="form-control" placeholder="请您填写用户名" required>
...
/index.php?p=home&m=index&a=register">
            <input name="acc" type="text" class="form-control" placeholder="请您填写用户名" required>
              ...
              <div class="post-meta">
                <div class="column">
                  ...
                  <span class="post-comments">
                    ...
                    <a href="#">评论数：<?php echo $_smarty_tpl->tpl_vars['article']->value['comment_num'];?>
</a>
                  </span>
                </div>
                <div class="column"><span><?php echo date('Y-m-d',$_smarty_tpl->tpl_vars['article']->value['post_date']);?>
</span></div>
              </div><!-- .post-meta -->
              <h3 class="post-title"><?php echo $_smarty_tpl->tpl_vars['article']->value['title'];?>
</h3>
              <p><?php echo $_smarty_tpl->tpl_vars['article']->value['intro'];?>
</p>
              <a href="<?php echo C('URL');?>
/index.php?p=home&m=index&a=showInfo&id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
">点击阅读更多</a>
            </div><!-- .post-body -->
          </article><!-- .post-item -->
		  <?php
...
?>
				<li><a href="#"><?php echo str_repeat('--- --- ',$_smarty_tpl->tpl_vars['cat']->value['space']);
