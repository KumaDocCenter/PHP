<?php
/* Smarty version 3.1.29, created on 2018-07-11 15:56:25
  from "F:\home\class\day14\code\blog31\app\admin\view\User\userAdd.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5b45b829d63580_67258012',
  'file_dependency' => 
  array (
    '8d5f8ad2c097d080b70502038a0655d7ebb9b6c7' => 
    array (
      0 => 'F:\\home\\class\\day14\\code\\blog31\\app\\admin\\view\\User\\userAdd.html',
      1 => 1531295694,
      2 => 'file',
    ),
  ),
...
function content_5b45b829d63580_67258012 ($_smarty_tpl) {
?>
...
/index.php?p=admin&m=user&a=adh">
                            <div class="st-form-line" style="z-index: 680;">
                                <span class="st-labeltext">帐号</span>
                                <input name="acc" type="text" class="st-forminput" style="width:510px" value="">
                                <div class="clear" style="z-index: 670;"></div>
                            </div>
                            <div class="st-form-line" style="z-index: 680;">
                                <span class="st-labeltext">密码</span>
                                <input name="pwd" type="text" class="st-forminput" style="width:510px" value="">
                                <div class="clear" style="z-index: 670;"></div>
                            </div>
                            <div class="st-form-line" style="z-index: 680;">
                                <span class="st-labeltext">用户类型</span>
                                <label class="margin-right10"><input type="radio" name="type" value="0" checked class="uniform"/> 普通用户</label>
                                <label class="margin-right10"><input type="radio" name="type" value="1" class="uniform"/> 管理员</label>
                                <div class="clear" style="z-index: 670;"></div>
                            </div>
                            <div class="st-form-line" style="z-index: 680;">
                                <span class="st-labeltext">昵称</span>
                                <input name="nickname" type="text" class="st-forminput" style="width:510px" value="">
                                <div class="clear" style="z-index: 670;"></div>
                            </div>
                            <div class="st-form-line" style="z-index: 680;">
                                <span class="st-labeltext">手机号</span>
                                <input name="cell" type="text" class="st-forminput" style="width:510px" value="">
                                <div class="clear" style="z-index: 670;"></div>
                            </div>
