...
1. 将code/mvc目录改名为blog31，
   ...
   ![1531291206947](img2/2)

   改名为blog31:

   ![1531291235746](img2/3)

2. 配置一个基于域名虚拟主机，域名为www.blog31.com

   在httpd-vhosts.conf文件中增加如下图所示的虚拟主机配置项：

   ![1531291311545](img2/4)

   修改hosts文件，

   ![1531291371313](img2/5)

3. 重启apache，测试访问效果：

   ![1531291456736](img2/6)

   访问效果为：

   ![1531291515331](img2/7)
...
![1531406458061](img2/43)

代码如下：

![1531406531563](img2/44)
...
![1531407704334](img2/49)

代码如下：

![1531407665958](img2/48)
